    ...
    <div class="content">
      ...
      >
        ...
        >
          ...
          <eeWidget v-bind:widget="widgets[item.i]" />
...
const findByIndex = (i: string) => widgets.value.find((widget: any) => widget.i === i);

const fetchWidgetData = (widgets: any) => {
  const componentClone = [...this.widgets];
